...
//    self.scanImage = scanResult.imgScanned;
    ...
    NSString*strResult = [NSString stringWithFormat:@"%@",array[0]];
    NSString *strimage =  [NSString stringWithFormat:@"%@",array[1]];
    self.scanImage = [UIImage imageNamed:strimage];
    if (!strResult) {
   ...
   // __weak typeof(alertController) wAlert = alertController;
    [alertController addAction:[UIAlertAction actionWithTitle:@"继续扫码" style:UIAlertActionStyleDestructive handler:^(UIAlertAction *action) {
       [self reStartDevice];
